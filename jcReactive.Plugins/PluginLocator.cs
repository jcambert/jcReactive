...
{
    public class PluginLocator<T> where T:class,IPlugin,new()
    {
        public PluginLocator(PluginAssemblyCache<T> pluginAssemblyDictionary)
        {
        ...
        private readonly PluginAssemblyCache<T> _PluginAssemblyDictionary;
        ...
        public Type Locate(Type t)
        {
            return Locate(new[] { t });
        }
        public Type Locate( IEnumerable<Type> serviceTypes)
        {
