...
namespace jcReactive.Plugins
{
    ...
    /// </summary>
    public class PluginAssemblyCache<T> where T:class,IPlugin,new()
    {
        public PluginAssemblyCache(IPluginProvider pluginProvider, PluginLoader<T> pluginLoader)
        {
        ...
        private readonly PluginLoader<T> _PluginLoader;
