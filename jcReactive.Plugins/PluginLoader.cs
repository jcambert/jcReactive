...
{
    public class PluginLoader<T> where T:class,IPlugin,new()
    {
        public PluginLoader(PluginSnippetCompiler<T> pluginSourceCompiler)
        {
        ...
        private readonly PluginSnippetCompiler<T> _PluginSourceCompiler;
